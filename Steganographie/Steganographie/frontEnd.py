...
# UI Components
#tk.Label(root, text="Venera", fg=TEXT_COLOR, bg=BG_COLOR, font=("Arial", 12, "bold")).pack()
...
btn_hide = tk.Button(root, text="Hide Message 🕵🏾‍♂️", font=("Arial", 12, "bold"), bg=BUTTON_COLOR, fg=TEXT_COLOR, command=hide_message)
